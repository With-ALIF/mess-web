...
const summaryHtml =   <div style="margin-bottom:10px;">   <strong>${title}</strong>   </div>   <div class="table-wrapper" style="max-height:none;">   <table class="summary-table">   <thead>   <tr>   <th>Meal</th>   <th>Count</th>   <th>Total Amount</th>   </tr>   </thead>   <tbody>   <tr>   <td>Breakfast</td>   <td>${summary.breakfastCount || 0}</td>   <td>${formatCurrency(summary.breakfastTotal || 0)}</td>   </tr>   <tr>   <td>Lunch</td>   <td>${summary.lunchCount || 0}</td>   <td>${formatCurrency(summary.lunchTotal || 0)}</td>   </tr>   <tr>   <td>Dinner</td>   <td>${summary.dinnerCount || 0}</td>   <td>${formatCurrency(summary.dinnerTotal || 0)}</td>   </tr>   </tbody>   </table>   </div>  ;

const detailsHtml =   <div class="table-wrapper" style="max-height:none; margin-top:8px;">   <table class="report-table">   <thead>   <tr>   <th>Roll</th>   <th>Name</th>   <th>Breakfast</th>   <th>Lunch</th>   <th>Dinner</th>   <th>Total</th>   </tr>   </thead>   <tbody>   ${list   .map(   (s) =>
<tr>
<td>${s.rollNo}</td>
<td>${s.name}</td>
<td>${s.breakfast || 0}</td>
...
</tr>  )   .join("")}   </tbody>   </table>   </div>   <div class="grand-total">   Grand Total: ${formatCurrency(summary.grandTotal || 0)}   </div>  ;
